        ...
        <Section>
          ...
          <div className={'mt-8'}>
            ...
            <div className={'text-sm mt-1 text-gray-9'}>
              Sign in to access more features on this website.
            </div>
            <form
              className={'mt-4'}
            >
              <div>
                <input
                  ...
                  className="box-content w-full md:w-72 bg-gray-a1 px-2 py-1 outline-none border border-gray-12 hover:border-accent -mx-2 text-sm"
